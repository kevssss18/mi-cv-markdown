...
## Formación Académica
- **Ingeniería en Sistemas Computacionales** | TecNM Campus Morelia (En curso, 6to Semestre).
- **Especialidad:** Sistemas Operativos y Redes.

## Habilidades Técnicas
- **Lenguajes:** Python, Java, SQL, C.
- **Herramientas:** Visual Studio Code, Git/GitHub, Krita (Animación).
- **Sistemas:** Linux (Ubuntu), VirtualBox, Windows.
- **Otros:** Creación de Compiladores, Networking (IP Addressing).
